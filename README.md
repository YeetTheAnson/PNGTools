...
```bash
python PNGTools.py -i <input_file> -o <output_file> -p <process>
```
...
```bash
python PNGTools.py -i test.png -p analyze
```
...
```bash
python PNGTools.py -i test.png -p size
```
...
```bash
python PNGTools.py -i test.png -p color-count
```
...
```bash
python PNGTools.py -i test.png -p pick-color --x 100 --y 100
```
...
```bash
python PNGTools.py -i test.png -o rotated.png -p rotate --angle 45
```
...
```bash
python PNGTools.py -i test.png -o skewed.png -p skew --x 20 --y 30
```
...
```bash
python PNGTools.py -i test.png -o mirror_h.png -p mirror --horizontal
python PNGTools.py -i test.png -o mirror_v.png -p mirror --vertical
python PNGTools.py -i test.png -o mirror_both.png -p mirror --horizontal --vertical
```
...
```bash
python PNGTools.py -i test.png -o text.png -p text --text "Hello World" --color FF0000 --size 24 --x 50 --y 50
python PNGTools.py -i test.png -o text_bold.png -p text --text "Bold Text" --color 0000FF --size 24 --bold --x 50 --y 50
python PNGTools.py -i test.png -o text_italic.png -p text --text "Italic Text" --color 00FF00 --size 24 --italic --x 50 --y 50
```
...
```bash
python PNGTools.py -i test.png -o pixelated.png -p pixelate --size 8
```
...
```bash
python PNGTools.py -i test.png -o blurred.png -p blur --radius 5
```
...
```bash
python PNGTools.py -i test.png -o border_black.png -p border --thickness 10
python PNGTools.py -i test.png -o border_red.png -p border --thickness 10 --color FF0000
```
...
```bash
python PNGTools.py -i test.png -o round_uniform.png -p round-corners --cornerradius 20
python PNGTools.py -i test.png -o round_varied.png -p round-corners --tl 10 --tr 20 --bl 30 --br 40
```
...
```bash
python PNGTools.py -i test.png -o multiply_h.png -p multiply --x 3 --y 1
python PNGTools.py -i test.png -o multiply_v.png -p multiply --x 1 --y 3
python PNGTools.py -i test.png -o multiply_both.png -p multiply --x 2 --y 2
```
...
```bash
python PNGTools.py -i test.png -o hidden_text.png -p hide-text --message "This is a secret message"
python PNGTools.py -i hidden_text.png -p extract-hidden-text
```
...
```bash
python PNGTools.py -i test.png -o tone_blue.png -p color-tone --color 0000FF
```
...
```bash
python PNGTools.py -i test.png -o opacity_50.png -p opacity --level 50
```
...
```bash
python PNGTools.py -i test.png -o noise_random.png -p noise --amount 20
python PNGTools.py -i test.png -o noise_similar.png -p noise --amount 20 --tolerance 30
```
...
```bash
python PNGTools.py -i test.png -o compressed_low.png -p compress --level 20
python PNGTools.py -i test.png -o compressed_medium.png -p compress --level 50
python PNGTools.py -i test.png -o compressed_high.png -p compress --level 80
```
...
```bash
python PNGTools.py -i test.png -o converted.jpg -p convert
python PNGTools.py -i test.png -o converted.webp -p convert
python PNGTools.py -i test.png -o converted.txt -p convert
```
...
```bash
python PNGTools.py -i solid_bg.png -o transparent_bg.png -p transparent --color FFFFFF --tolerance 10
```
...
```bash
python PNGTools.py -i solid_bg.png -o swapped_bg.png -p swap-color --from FFFFFF --to 00FF00 --tolerance 10
```
...
```bash
python PNGTools.py -i transparent.png -o centered.png -p center
```
...
```bash
python PNGTools.py -i transparent.png -o trimmed.png -p trim
```
...
```bash
python PNGTools.py -i transparent.png -o alpha_extracted.png -p alpha-extract --color 000000
```
...
```bash
python PNGTools.py -i colorful_transparent.png -o rgba_split.png -p split-rgba
```
...
python PNGTools.py -i test.png -o test_base64.txt -p convert

# Process base64 image
python PNGTools.py -i test_base64.txt -o restored.png -p convert
```
...
```bash
python PNGTools.py -i color_test.png -o swap_t5.png -p swap-color --from FF0000 --to 00FF00 --tolerance 5
python PNGTools.py -i color_test.png -o swap_t15.png -p swap-color --from FF0000 --to 00FF00 --tolerance 15
python PNGTools.py -i color_test.png -o swap_t30.png -p swap-color --from FF0000 --to 00FF00 --tolerance 30
```
...
```bash
python PNGTools.py -i color_test.png -o trans_t5.png -p transparent --color FF0000 --tolerance 5
python PNGTools.py -i color_test.png -o trans_t15.png -p transparent --color FF0000 --tolerance 15
python PNGTools.py -i color_test.png -o trans_t30.png -p transparent --color FF0000 --tolerance 30
```
...
```bash
python PNGTools.py -i large_image.png -o comp_10.png -p compress --level 10
python PNGTools.py -i large_image.png -o comp_30.png -p compress --level 30
python PNGTools.py -i large_image.png -o comp_50.png -p compress --level 50
python PNGTools.py -i large_image.png -o comp_70.png -p compress --level 70
python PNGTools.py -i large_image.png -o comp_90.png -p compress --level 90
```
...
```bash
python PNGTools.py -i small.png -o small_hidden.png -p hide-text --message "Short message"
python PNGTools.py -i medium.png -o medium_hidden.png -p hide-text --message "This is a medium length message with some details."
python PNGTools.py -i large.png -o large_hidden.png -p hide-text --message "This is a longer message that contains more information. It should test the capacity of the steganography algorithm to hide larger amounts of text data within the image pixels."
```
...
```bash
python PNGTools.py -i tiny.png -o tiny_processed.png -p pixelate --size 2
```
...
```bash
python PNGTools.py -i very_large.png -o large_processed.png -p compress --level 80
```
...
```bash
python PNGTools.py -i test.png -o extreme_blur.png -p blur --radius 50
```
...
```bash
python PNGTools.py -i test.png -o extreme_noise.png -p noise --amount 100
```
...
python PNGTools.py -i base.png -o step1.png -p swap-color --from FFFFFF --to FFFF00 --tolerance 10
python PNGTools.py -i step1.png -o step2.png -p border --thickness 5 --color FF0000
python PNGTools.py -i step2.png -o step3.png -p round-corners --cornerradius 15
python PNGTools.py -i step3.png -o step4.png -p text --text "Test Complete" --color 000000 --size 24 --bold --x 20 --y 20
python PNGTools.py -i step4.png -o final.png -p compress --level 30
```
